...
typedef Report(String);

void main() {
  var o1 = querySelector('#output');
  o1.text = 'Ready.';
  var b20 = querySelector('#g20b') as ButtonElement;
  var b35 = querySelector('#g35b') as ButtonElement;
  var rep = (s) => o1.text = s;
  b20.onClick.listen((evt) => report(g20, rep));
  b35.onClick.listen((evt) => report(g35, rep));
}

Future report(String data, Report r) async {
  var start = new DateTime.now();
  var n = await count_cycles(read(data));
  var stop = new DateTime.now();
  var t = stop.millisecondsSinceEpoch - start.millisecondsSinceEpoch;
  var s = "Counted $n cycles in $t ms";
  r(s);
}
